...
def add_noise_and_round(data, noise_level=0.05):  # Reduced noise level
...
def generate_pattern(pattern_type):
    ...
    return add_noise_and_round(pattern, noise_level=0.05)  # Reduced noise level
...
# Generate complementary patterns with less noise
complementary = add_noise_and_round(100 - microservices, noise_level=0.07)  # Reduced noise level
